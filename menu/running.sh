...
# // Exporting URL Host
export Server_URL="raw.githubusercontent.com/cakill26/lekong/main"
...
Validated_Keys="$( curl -s https://${Server_URLL}/validated-registered-license-key.txt | grep $Algoritma_Keys | cut -d ' ' -f 1 )"
if [[ "$Algoritma_Keys" == "$Validated_Keys" ]]; then
    if [[ $Algoritma_Keys == "" ]]; then
        Skip="true"
    else
        Limit_License="$( curl -s https://${Server_URLL}/validated-registered-license-key.txt | grep $Algoritma_Keys | cut -d ' ' -f 2 )"
        Start_License="$( curl -s https://${Server_URLL}/validated-registered-license-key.txt | grep $Algoritma_Keys | cut -d ' ' -f 3 )"
        End_License="$( curl -s https://${Server_URLL}/validated-registered-license-key.txt | grep $Algoritma_Keys | cut -d ' ' -f 4 )"
        Bot="$( curl -s https://${Server_URLL}/validated-registered-license-key.txt | grep $Algoritma_Keys | cut -d ' ' -f 5 )"
        Backup="$( curl -s https://${Server_URLL}/validated-registered-license-key.txt | grep $Algoritma_Keys | cut -d ' ' -f 6 )"
        Beta="$( curl -s https://${Server_URLL}/validated-registered-license-key.txt | grep $Algoritma_Keys | cut -d ' ' -f 7 )"
        Tipe="$( curl -s https://${Server_URLL}/validated-registered-license-key.txt | grep $Algoritma_Keys | cut -d ' ' -f 8 )"
        Issue_License="$( curl -s https://${Server_URLL}/validated-registered-license-key.txt | grep $Algoritma_Keys | cut -d ' ' -f 9-100 )"
    fi
    exp=$( curl -s https://${Server_URLL}/validated-registered-license-key.txt | grep $Algoritma_Keys | cut -d ' ' -f 4 )
