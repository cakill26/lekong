...
# Link Hosting Kalian
geovpn="cakill26.github.io/lekong/ambe/ss"
clear
...
wget -q -O /usr/local/sbin/ss-menu "https://cakill26.github.io/lekong/ambe/menu/ss-menu.sh" && chmod +x /usr/local/sbin/ss-menu
sleep 1
